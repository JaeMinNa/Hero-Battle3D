...
public class PlayerBaseState : IState
{
    ...
    protected virtual void AddInputActionsCallbacks()
    {
        ...
        input.PlayerActions.Skiil.performed += OnSkillPerformed;
        input.PlayerActions.Skiil.canceled += OnSkillCanceled;
    }
    ...
    protected virtual void OnSkillPerformed(InputAction.CallbackContext obj)
    {
        if (stateMachine.Player.CanSkill == false) return; 
        stateMachine.IsSkill = true;
        stateMachine.Player.CheckCoolTime();
        GameManager.Instance.UIManager.CoolTimeCount();
    }

    protected virtual void OnSkillCanceled(InputAction.CallbackContext obj)
    {
    ...
    {
        stateMachine.ChangeState(stateMachine.SkillAttackState);
    }
}